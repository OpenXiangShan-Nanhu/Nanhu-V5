...
(
  ...
  val fpSchdParams = {
    ...
    SchdBlockParams(Seq(
      ...
      IssueBlockParams(Seq(
        ExeUnitParams("FEX2", Seq(FdivCfg), Seq(FpWB(port = 2, 1)), Seq(Seq(FpRD(2, 1)), Seq(FpRD(5, 1)))),
        ExeUnitParams("FEX3", Seq(FdivCfg), Seq(FpWB(port = 3, 1)), Seq(Seq(FpRD(6, 1)), Seq(FpRD(7, 1)))),
      ), numEntries = 18, numEnq = 2, numComp = 16),
    ),
  ...
  val memSchdParams = {
    ...
    SchdBlockParams(Seq(
      ...
      IssueBlockParams(Seq(
        ExeUnitParams("LDU0", Seq(LduCfg), Seq(IntWB(5, 0), FpWB(2, 0)), Seq(Seq(IntRD(8, 0))), true, 2),
      ), numEntries = 16, numEnq = 1, numComp = 15),
      IssueBlockParams(Seq(
        ExeUnitParams("LDU1", Seq(LduCfg), Seq(IntWB(6, 0), FpWB(3, 0)), Seq(Seq(IntRD(9, 0))), true, 2),
      ), numEntries = 16, numEnq = 1, numComp = 15),
//      IssueBlockParams(Seq(
...
//      ), numEntries = 16, numEnq = 2, numComp = 14),
      ...
      IssueBlockParams(Seq(
        ExeUnitParams("STD0", Seq(StdCfg, MoudCfg), Seq(), Seq(Seq(IntRD(5, 2), FpRD(6, 0)))),
      ), numEntries = 16, numEnq = 1, numComp = 15),
      IssueBlockParams(Seq(
        ExeUnitParams("STD1", Seq(StdCfg, MoudCfg), Seq(), Seq(Seq(IntRD(3, 2), FpRD(7, 0)))),
      ), numEntries = 16, numEnq = 1, numComp = 15),
    ),
